...
public class HomePage 
{
	...
	private WebElement category(String value) {
		String xpath= "//ul[@id='navBarMegaNav']/descendant::a[text()='Fruits & Vegetables']";
	...
	private WebElement brand(String value) {
		String xpath="//ul[@id='navBarMegaNav']/descendant::a[text()='"+value+"']";
		return driver.findElement(By.xpath(xpath));
	}
	/*filter the Brand*/
	...
	public void tfSearch(String FruitsVegetables) throws Throwable
	{
		try {
		web.mouseOver(driver, musOvr);
		web.mouseOver(driver, brand(FruitsVegetables));
